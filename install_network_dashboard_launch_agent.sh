...
COLLECTOR_MODE="${COLLECTOR_MODE:-snapshot}"
SNAPSHOT_POLL_INTERVAL="${SNAPSHOT_POLL_INTERVAL:-5}"
...
echo "Collector: $COLLECTOR_MODE interval=${INTERVAL}s snapshot_poll=${SNAPSHOT_POLL_INTERVAL}s"
